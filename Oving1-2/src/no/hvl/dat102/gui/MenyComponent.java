...
public class MenyComponent {
	 ...
	 * @param main			referanse til hoved objectet, brukes og sendes videre til chooseMethod()
	 * @param menuItemS		String navn til vindu og meny element
	 * @param buttonS		String navn til knapp
	 * @param metodeNR		brukt for å velge riktig metode til riktig knapp, sendes videre til choosemethod()
	 */
	public static void attachComponents(JMenu menu, Meny main, String menuItemS, String buttonS, int metodeNR) {
		
		// lager  Popup vindu, menyelement (feks lagre som), panel, knapp og tekstfield til popup vindu
		MenyComponent menyComposites = new MenyComponent( new JFrame(menuItemS), new JMenuItem(menuItemS), new JPanel() , new JButton(buttonS), new JTextField(10));
		...
		// lager action listner for knapp, textfield( om man trykker enter, og meny element( som åpner pop up)
